...
Content Core owns its extraction and summarization API, format processors, engine
...
Do not publish credentials, local configuration, private paths, user input content
or raw logs containing those values. Publish evidence summaries and public CI links.
